...
# this is gtk crap, stupid hocr needs glib/gtk for building
DEFINES		+= USE_GTK
DEFINES		+= PACKAGE_NAME=\\\"qhocr\\\" PACKAGE_TARNAME=\\\"qhocr\\\" PACKAGE_VERSION=\\\"0.10.16\\\" PACKAGE_STRING=\\\"qhocr_0.10.16\\\" PACKAGE_BUGREPORT=\\\"Diego_Iastrubni_\<diegoiast\@gmail.com\>\\\" PACKAGE=\\\"libhocr\\\" VERSION=\\\"0.10.16\\\" BUILD=\\\"qt4\\\"
LIBS+=-lglib-2.0 -lgtk-x11-2.0 
INCLUDEPATH	+= /usr/include/gtk-2.0 /usr/lib/gtk-2.0/include /usr/include/glib-2.0 /usr/lib/glib-2.0/include
...
SOURCES = \
	...
	src/libhocr-0.10.16/src/ho_gtk.c		\
